...
<!-- --------------------------------------------------------------------------------- -->
    ...
    <div class="head-img">
        <img src="<?= BASE_URL ?>img/overhead-farm.jpg" alt="Overhead Farm Image">
    </div>
...
<!-- --------------------------------------------------------------------------------- -->
    ...
    <?php foreach ($featuredProducts as $product): ?>
        <div class="ssn-box">
            ...
            <a href="<?= BASE_URL ?>products.php" class="red-btn">Buy</a>
        </div>
    <?php endforeach; ?>
</section>
...
<!-- --------------------------------------------------------------------------------- -->
    ...
    <section id="cta">
        ...
        <a href="<?= BASE_URL ?>products.php" class="red-btn">Browse Products</a>
    </section>
